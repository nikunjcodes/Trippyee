    ...
    <div className="min-h-screen bg-gradient-to-br from-green-100 to-blue-100 p-8">
      <Card className="max-w-4xl mx-auto shadow-lg">
        <CardHeader className="bg-gradient-to-r from-green-600 to-blue-600 text-white">
          <CardTitle className="text-3xl font-bold">Plan Your Trip to {city?.City}</CardTitle>
          <CardDescription className="text-green-100">
            Fill in the details to create your personalized itinerary
          </CardDescription>
        </CardHeader>
        <CardContent className="p-6">
          <form onSubmit={(e) => { e.preventDefault(); generateItinerary(); }} className="space-y-6">
            ...
            <div>
              ...
              <Select onValueChange={(value) => handleSelectChange('tripType', value)} defaultValue={tripDetails.tripType}>
                <SelectTrigger>
            ...
            <div>
              ...
              <Select onValueChange={(value) => handleSelectChange('budget', value as 'low' | 'medium' | 'high')} defaultValue={tripDetails.budget}>
                <SelectTrigger>
            ...
            <div className="bg-green-100 p-4 rounded-lg">
              ...
              <p><strong>Estimated Days:</strong> {estimatedDays}</p>
